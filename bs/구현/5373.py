...
def rotate_up_clockwise():
    up[0][0], up[0][1], up[0][2], up[1][0], up[1][1], up[1][2], up[2][0], up[2][1], up[2][2] = \
        up[2][0], up[1][0], up[0][0], up[2][1], up[1][1], up[0][1], up[2][2], up[1][2], up[0][2]
    front[0][0], front[0][1], front[0][2], right[0][0], right[1][0], right[2][0], back[0][0], back[0][1], back[0][2], left[0][0], left[1][0], left[2][0] = \
        left[0][0], left[1][0], left[2][0], front[0][0], front[0][1], front[0][2], right[0][0], right[1][0], right[2][0], back[0][0], back[0][1], back[0][2]
